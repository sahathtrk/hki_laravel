@extends('base') 
@section('judul-halaman', 'Detail Rekap Lembar Evaluasi')  
@section('konten')  

    <!-- HEADER -->
    <div class="row">
        <div class="col-12">
            <h1>Detail Rekap Lembar Evaluasi</h1>
        ...
        <div style="width:600px;" class="ml-4">   
            <div id="evaluasi-stage">
                        ...
                        <div class="d-flex flex-grow-1 min-width-zero">
                            ...
                            <div class="card-body align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center">
                                <div class="list-item-heading mb-0 truncate w-80 mb-1 mt-1">
                                    <h5>Detail Rekap Lembar Evaluasi</h5>
                                </div>
                            </div>
                ...
                <div class="text-right">  
                    <a href="{{ route('survei.evaluasi.rekap', $evaluasi->id) }}" class="btn btn-danger btn-sm mb-2"> Kembali </a>
                </div>
