@extends('base') 
@section('judul-halaman', 'Update Laporan Pelayanan')  
@section('konten')  

    <!-- HEADER -->
    <div class="row">
        <div class="col-12">
            <h1>Update Laporan pelayanan</h1>
    ...
    <div class="row">
        ...
        <div style="width:600px;" class="ml-4">  
            ...
            <div class="card mb-4">
                <div class="card-body"> 
                    ...
                    <div class="d-flex flex-grow-1 min-width-zero">
                        ...
                        <div class="d-flex flex-grow-1 min-width-zero"> 
                            <h5>Deskripsi Lembar pelayanan</h5> 
                        </div>
                    ...
                    @elseif (session('notifikasi_create') == "failed")
                        <div class="alert alert-danger alert-dismissible fade show rounded mb-0" role="alert">
                            <strong>Gagal!</strong> Lembar pelayanan gagal dibuat.
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                        </div>  
                    ...
                    <div class="form-group mt-4">
                        ...
                        <input type="text" class="form-control" name="judul" id="judul" placeholder="Masukan judul lembar pelayanan..." value="{{ $pelayanan->judul }}" >
                    </div> 

                    <!-- DESKRIPSI --> 
                    <div class="form-group">
                        <label for="tanggal-kegiatan-program">Deskripsi</label>
                        <textarea class="form-control" name="deskripsi" id="deskripsi" placeholder="Masukan deskripsi lembar pelayanan...">{{ $pelayanan->deskripsi }}</textarea>
                    </div>  
                    ...
                    <div class="form-group">
                        ...
                        <select name="kategori" id="kategori" class="form-control"> 
                            <option value="{{ $pelayanan->kategori }}" hidden selected>{{ $pelayanan->kategori }}</option>
                            <option value="Laporan Pelayanan">Laporan Pelayanan</option>
                            <option value="Lembar pelayanan">Lembar pelayanan</option>
                        </select>
                    </div> 
            ...
            <div class="text-right">
                <button onclick="data_pelayanan_append();" type="button" class="btn btn-outline-primary btn-sm mb-2">
...
<script> 
    ...
    function data_pelayanan_append(){  
    ...
    function ajax_pertanyaan_create(){
        ...
        $("#universal-modal").find("#paragraf-p").html("Anda berhasil memperbaharui lembar pelayanan.");
