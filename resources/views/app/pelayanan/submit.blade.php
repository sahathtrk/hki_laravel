@extends('base') 
@section('judul-halaman', 'Submit Laporan Pelayanan')  
@section('konten')  

    <!-- HEADER -->
    <div class="row">
        <div class="col-12">
            <h1>Submit Laporan pelayanan</h1>
    ...
    let id_pelayanan = "{{ $pelayanan->id }}"; 
     function ajax_submit_jawaban(){ 
        $(".jawaban-div").each(function(){ 
            ...
            data_upload.append('id_survei', id_pelayanan);
        ...
        $("#universal-modal").find("#paragraf-p").html("Anda berhasil mengirim lembar pelayanan.");
        $("#universal-modal").find("#tutup-btn").remove();
        $("#universal-modal").find("#aksi-btn").attr("href", "");
        $("#universal-modal").find("#aksi-btn").text("Keluar");
        $("#universal-modal").find("#aksi-btn").attr("href", "/pelayanan/read");
    }
</script>
@endsection